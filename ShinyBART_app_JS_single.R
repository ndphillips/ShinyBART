      ...
      server <- function(input, output, session) {
        ...
        PageLayouts <- reactive({
          ...
          if (CurrentValues$page == "welcome") {
            ...
            if (CurrentValues$errors == "Blank_Name") {
              inputLabel <- p(style = "color:Red", "Please enter a unique ID!")
            } else {
              inputLabel <- p("Please enter a unique ID")
            }
            ...
            return(
              list(
                ...
                p("In Phase 1, you will play a game called 'The Balloon Game' and try to earn as many points as possible while making risky decisions."),
          ...
          if (CurrentValues$page == "inst1") {
            ...
            return(
                list(
                  ...
                  p(paste("You will play a total of", balloons.n, "balloons in this game. They will be presented in ", blocks.n, "groups of ", balloonsPerBlock, "balloons. You will receive feedback about your earnings after each block.")),
                  ...
                  p(paste("You can never lose points that you've earned after saving a balloon. Your goal is to earn as many points as possible across all", balloons.n, "balloons")),
          ...
          if (CurrentValues$page == "game") {
            ...
            # The block counter should show "training" during the training round
          ...
          if (CurrentValues$page == "gameend") {
              ...
              return(list(h3("You finished the game!"),
                        p(paste("You earned", CurrentValues$points.cum, "points in the game. Congratulations!")),
        ...
        # Look for the last balloon in a Block: Go to the feedback Page
        observeEvent(CurrentValues$balloon, {
          
          if(CurrentValues$balloon > balloonsPerBlock) {
            GameData$point.hist <- c(GameData$point.hist, CurrentValues$points.cum)
